                ...
                <div class="card-body">
                    <form method="POST" action="/devfullphp_update/{{$formation_devfullphps->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="video" type="file" class="form-control @error('video') is-invalid @enderror" name="video" value="{{$formation_devfullphps->video }}" required autocomplete="video" autofocus>
                                <p>
                                    @if($errors->has('video'))
                                    {{$errors->first('video')}}
                                    @endif
